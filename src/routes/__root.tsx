...
const APP_NAME = "חיפוש | עו״ד אברהם זיו כהן";
  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "חיפוש באתר משרד עו״ד אברהם זיו כהן — התחדשות עירונית, תמ״א 38, פינוי-בינוי, מיסוי מקרקעין ופרויקטים.",
      },
      { name: "theme-color", content: "#0c1a32" },
    ],
    links: [
